    ...
    if(getvol()<150):
        ...
        if(percent<=100):
            if(percent<=10):
                ...
                cmd = "dunstify -i /home/nk/.config/hypr/Scripts/assets/vol2.png -r 1234 -t 2000 \'Volume : "+str(percent)+" %\'"
            elif(percent>50 and percent<100):
                cmd = "dunstify -i /home/nk/.config/hypr/Scripts/assets/vol3.png -r 1234 -t 2000 \'Volume : "+str(percent)+" %\'"
            if(percent>=100 and percent<=150):
                cmd = "dunstify -i /home/nk/.config/hypr/Scripts/assets/vol4.png -r 1234 -t 2000 \'Volume : "+str(percent)+" %\'"    
            subprocess.run(cmd,shell=True,capture_output=True,text=True)
